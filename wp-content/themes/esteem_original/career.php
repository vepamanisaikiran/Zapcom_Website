   ...
   <span class="zap_h1" style="color:#003d5f;"> Our Culture</span>
    ...
    <div class="row">   
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div id="cul-img_2" class="culture_image" style="background-image: url('/zapcg/wp-content/themes/esteem/images/career/career_culture_2.jpg');background-position: 50% !important;">           
            </div>
        </div>
...
-->
    ...
    <section id="job_vacancy_sec"> 
        ...
        <span class="zap_h1" style="color:#003d5f;"> Our Opportunities</span>
        <img src="<?php bloginfo('template_directory'); ?>/images/horizontal_line.png"/>
        </div>
        <div class="row">
        ...
        <div class="col-md-5" style="padding: 0 20px;">
                <span class="zap_h3"> Current Openings </span>
...
//												echo '<optgroup label="'.$position_name_arr[$x].'">';
								...
								<div class="txt-div full" style=" text-align: center; width: 95%;  border-radius: 4px; margin-left: 6px;">
									...
									<input type="file" id="file" placeholder="Upload Your Resume" name="file" class="txt-form-zp" required="required" accept="application/pdf,application/vnd.openxmlformats-officedocument.wordprocessingml.document" style="margin: 0px !important; margin-top: -6px; font-family: 'montserratLight';" required>
