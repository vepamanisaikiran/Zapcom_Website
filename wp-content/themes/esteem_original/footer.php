...
<div class="copy-rt" >
	<div class="container row" id="lower_sec">
			...
			<div class=" footer_mail">
					...
					<span class=footer_mail_text>
						<a href="mailto:info@zapcg.com" class="footer_text_color">
							<span>&nbsp;&nbsp;&nbsp;<!-- <span style="font-weight: 500 !important; font-size:2.5vmin; font-family:'montserratbold';">Contact us:</span> --> &nbsp; <i class="fa fa-envelope footer_icon"></i>&nbsp;&nbsp;&nbsp;&nbsp;info@zapcg.com</span>
						</a>
					</span>
				</div>
		</div>
		...
		<div class="col-md-6 col-sm-6 col-xs-12 footer_copyright footer-col">
			<div class="copy-cnt">  © 2015 Zapcom Group. All Right Reserved  |<a href="http://localhost/zapcg1/index.php/policy/">  Privacy Policy </a></div>
		</div>
