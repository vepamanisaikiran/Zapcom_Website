...
<section class="zap_section1">
        <div class="zap_banner zap_img" id="how_we_do_banner_img"> 
    ...
    <ul>
     <li><a href="#global_delivery"> Global Delivery </a></li>
    ...
    <div id="global_delivery">
     <span class="zap_h1" style="color:#003d5f;">Global Delivery</span>
...
<section id="process" class=" projects" style="">
	<span class="zap_h1" style="color:#003d5f;">Our Process</span>
	<img src="<?php bloginfo('template_directory'); ?>/images/horizontal_line.png" style="display: block; margin:auto; "/>
    <p class="subheading zap_body">
    ...
    <div class="containers" style="margin-left: 16%;height:80%;">
        <div class="project row">
            <!-- <div class="col-md-10"></div> -->
            <p class="project-name  hideme" style="transform: rotate(-90deg) translate(-70px, -98px);">Discovery</p>

            <div class="col-md-3 col-sm-3 hideme">
                <img class="project-icon" src="<?php bloginfo('template_directory'); ?>/images/howwedoProcess/idea.svg">
            </div>
            <div class="col-md-8 col-sm-8 hideme">
